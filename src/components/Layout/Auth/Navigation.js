...
import logoDesk from "../../../assets/logo_text.svg"
import logoMobile from "../../../assets/logo_icon.png"
      ...
      <AppBar1 className="navigation">
        <Toolbar position="static">
          <div className="flex">
            ...
            <a
              href="#overview"
              className={isActive ? "active" : "album"}
              name="overview"
              index={0}
            ...
            <a
              href="#feature"
              className={this.isActive ? "active" : "album"}
              name="feature"
              index={1}
